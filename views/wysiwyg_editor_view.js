...
SC.WYSIWYGEditorView = SC.View.extend({
  ...
  */
  ...
  /** @private
    ...
    This has been tested extensively in Firefox, Safari and Chrome, and every effort has been made
    to ensure consistent output. However, contenteditable line breaks are a hive of cross-browser
    incompatibilities, so if you have any issues, please compile a reliably reproductive set of
    keystrokes and open an issue on [GitHub](https://github.com/sproutcore/rich-text-editor/issues/new).
